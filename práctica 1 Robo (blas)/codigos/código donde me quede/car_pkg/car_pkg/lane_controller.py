...
class LaneController(Node):
    ...
    def __init__(self):
        ...
        self.BASE_SPEED = 15.0  # rad/s - Velocidad base más alta para avanzar
        self.KP = 1  # Ganancia proporcional REDUCIDA para suavizar
        self.MAX_TURN_DIFF = 8.0  # Máxima diferencia de velocidad entre ruedas
        ...
        self.prev_error = 0.0
        self.error_smoothing = 0.7  # Factor de suavizado (0-1, mayor = más suave)
